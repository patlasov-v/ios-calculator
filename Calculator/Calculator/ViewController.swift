...
//  Calculator
//
//  Created by Viktor on 12.04.2026.
//
...
class ViewController: UIViewController {
    ...
    private let alertView: AlertView = {
        ...
        let alertWidth: CGFloat = screeenBounds.width - 40
        let x: CGFloat = screeenBounds.width / 2 - alertWidth / 2
        let y: CGFloat = screeenBounds.height / 2 - alertHeight / 2
...
extension UIButton {
    ...
    func animateTap() {
        ...
        opacityAnimation.values = [1, 0.85, 1]
